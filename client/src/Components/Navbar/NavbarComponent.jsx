...
function NavbarComponent({ opened, userID }) {
  ...
  return (
    <Navbar p="md" hiddenBreakpoint="sm" hidden={!opened} width={{ sm: 200, lg: 400 }}>
      ...
      >
        ...
        <div style={{
				  width: '150px', marginLeft: 'auto', marginRight: 'auto', marginTop: '20px', marginBottom: '20px',
        }}
        >
          <Image
            radius="md"
        ...
        <div style={{
				  marginTop: '20px', marginBottom: '20px', display: 'flex', justifyContent: 'center',
        }}
        >
          ...
          <div style={{ width: 340, margin: 'auto', marginTop: '10px' }}>
            <Card shadow="sm" p="lg">
              ...
              <Button
                ...
                color="blue"
                fullWidth
                style={{ marginTop: 14, fontFamily: 'Overpass, sans-serif' }}
                size="md"
