...
const Login = ({ setUsuarioLoggeado, setcorreoUsuarioLoggeado }) => {
					...
					(
						<div className="form">
							...
							<div className="register-form">
								...
								<p className="message">Ya tiene una cuenta? <a href="#" onClick={() => {
									setLoginPage(false);
								}}>Iniciar</a></p>
							</div>
						</div>
					...
					(
						<div className="form">
							...
							<div className="login-form">
								...
								<p className="message">No estas registrado? <a href="#" onClick={() => {
									setLoginPage(true);
								}}>Crear cuenta</a></p>
							</div>
						</div>
